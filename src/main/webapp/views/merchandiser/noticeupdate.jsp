...
<main>
<form action="noticeProc?flag=update" name="noticeForm" method="post">
...
<table>
	...
	<tbody>
		...
		<tr>
			<td class="col1">제목</td>
			<td class="col2">
			<input type="text" id="label" name="label" class="chk1" title="공지사항제목" value="${notice.label}">
			</td>
		</tr>
		<tr>
			<td class="col1">작성자</td>
			<td class="col2"><input type="text" id="author_id" name="author_id"
			value="${notice.author_id}"></td>
		</tr>
		
		<tr>
			<td class="col1">내용</td>
			<td class="col2">
			<textarea class="chk1" id="content" title="공지사항내용" rows="10" cols="30" name="content" style="resize: none;">${notice.content}</textarea>
		</td>
		</tr>
		<tr>
			<td class="col1">작성일자</td>
			<td class="col2"><input type="text" id="reg_date" name="regdate" disabled="disabled" value="${notice.reg_date}">
		</td>
	...
	<tfoot>
		<tr>
			<td colspan="3">
				<button type="button" class="noticeUp">수정</button>
